...
class TestUtilities(unittest.TestCase):
    ...
    def test_deprecation_formatter(self):
        ...
        msg = format_message(
            "deprecated_function", "use something else instead", "1.0.0"
        )
        expected = (
            "'deprecated_function' is deprecated and will be remove in future versions (1.0.0). use something else instead"
        )
        eq_(msg, expected)
