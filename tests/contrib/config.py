...
CASSANDRA_CONFIG = {"port": int(os.getenv("TEST_CASSANDRA_PORT", 9042))}
...
REDIS_CONFIG = {"port": int(os.getenv("TEST_REDIS_PORT", 6379))}

MONGO_CONFIG = {"port": int(os.getenv("TEST_MONGO_PORT", 27017))}
