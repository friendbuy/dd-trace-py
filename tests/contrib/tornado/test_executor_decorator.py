...
class TestTornadoExecutor(TornadoTestCase):
    ...
    @unittest.skipUnless(
        futures_available, "Futures must be available to test direct submit"
    )
    def test_on_executor_submit(self):
        ...
        eq_("http", request_span.span_type)
        eq_(
            "tests.contrib.tornado.web.app.ExecutorSubmitHandler", request_span.resource
        )
        eq_("GET", request_span.get_tag("http.method"))
        eq_("200", request_span.get_tag("http.status_code"))
    ...
    def test_on_executor_exception_handler(self):
        ...
        eq_("http", request_span.span_type)
        eq_(
            "tests.contrib.tornado.web.app.ExecutorExceptionHandler",
    ...
    def test_on_executor_custom_kwarg(self):
        ...
        eq_("http", request_span.span_type)
        eq_(
            "tests.contrib.tornado.web.app.ExecutorCustomHandler", request_span.resource
        )
        eq_("GET", request_span.get_tag("http.method"))
        eq_("200", request_span.get_tag("http.status_code"))
    ...
    def test_on_executor_custom_args_kwarg(self):
        ...
        eq_("http", request_span.span_type)
        eq_(
            "tests.contrib.tornado.web.app.ExecutorCustomArgsHandler",
            request_span.resource,
        )
        eq_("GET", request_span.get_tag("http.method"))
        eq_("500", request_span.get_tag("http.status_code"))
        ...
        eq_(
            ...
            request_span.get_tag("error.msg"),
        )
